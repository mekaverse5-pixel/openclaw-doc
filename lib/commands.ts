...
export const commands: Command[] = [
  ...
  {
    name: 'config',
    description: 'Non-interactive config helpers - get/set/unset/validate config values by path and print active config file',
    descriptionZh: '非交互式配置助手 - 通过路径获取/设置/删除/验证配置值，并打印活动配置文件',
    category: '配置',
    subcommands: [
      { name: 'get', description: 'Get config value - print value at given path', descriptionZh: '获取配置值 - 打印给定路径的值', category: '配置' },
      { name: 'set', description: 'Set config value - set value at given path', descriptionZh: '设置配置值 - 设置给定路径的值', category: '配置' },
      { name: 'unset', description: 'Remove config value - remove value at given path', descriptionZh: '删除配置值 - 移除给定路径的值', category: '配置' },
      { name: 'validate', description: 'Validate config - validate current config against schema', descriptionZh: '验证配置 - 根据模式验证当前配置', category: '配置' },
      { name: 'file', description: 'Print config file path - show active config file location', descriptionZh: '打印配置文件路径 - 显示活动配置文件位置', category: '配置' },
    ],
    examples: ['openclaw config get agents.defaults.model.primary', 'openclaw config set agents.defaults.model.primary claude-sonnet-4-20250514', 'openclaw config unset tools.web.search.apiKey', 'openclaw config validate'],
  },
  {
    name: 'secrets',
    ...
    category: '配置',
    subcommands: [
      { name: 'reload', description: 'Reload secrets - re-resolve SecretRefs and swap runtime snapshot', descriptionZh: '重新加载凭证 - 重新解析 SecretRefs 并交换运行时快照', category: '配置' },
      { name: 'audit', description: 'Audit secrets - scan for plaintext, unresolved refs, and precedence drift', descriptionZh: '审计凭证 - 扫描明文、未解析的引用和优先级漂移', category: '配置' },
      { name: 'configure', description: 'Configure secrets - interactive planner for provider setup and credential mapping', descriptionZh: '配置凭证 - 交互式规划器，用于提供商设置和凭证映射', category: '配置' },
      { name: 'apply', description: 'Apply a saved plan - execute or preflight a plan generated by configure', descriptionZh: '应用保存的计划 - 执行或预检由 configure 生成的计划', category: '配置' },
    ],
    examples: ['openclaw secrets reload', 'openclaw secrets audit', 'openclaw secrets configure', 'openclaw secrets apply --from /tmp/openclaw-secrets-plan.json'],
  },
  {
    name: 'security',
  ...
  // 消息命令
  {
    ...
    category: '消息',
    subcommands: [
      { name: 'send', description: 'Send message - send text or media to a channel', descriptionZh: '发送消息 - 向频道发送文本或媒体', category: '消息' },
      { name: 'poll', description: 'Poll for messages - create a poll', descriptionZh: '轮询消息 - 创建投票', category: '消息' },
      { name: 'react', description: 'Add reaction - add emoji reaction to a message', descriptionZh: '添加反应 - 添加表情符号反应', category: '消息' },
      { name: 'reactions', description: 'Manage reactions - list or manage message reactions', descriptionZh: '管理反应 - 列出或管理消息反应', category: '消息' },
      { name: 'read', description: 'Read messages - fetch message history', descriptionZh: '读取消息 - 获取消息历史', category: '消息' },
      { name: 'edit', description: 'Edit message - edit a sent message', descriptionZh: '编辑消息 - 编辑已发送的消息', category: '消息' },
      { name: 'delete', description: 'Delete message - delete a message', descriptionZh: '删除消息 - 删除消息', category: '消息' },
      { name: 'search', description: 'Search messages - search message history', descriptionZh: '搜索消息 - 搜索消息历史', category: '消息' },
      { name: 'thread', description: 'Thread operations - create, reply to threads', descriptionZh: '话题操作 - 创建、回复话题', category: '消息' },
      { name: 'broadcast', description: 'Broadcast - send message to multiple targets', descriptionZh: '广播 - 向多个目标发送消息', category: '消息' },
      { name: 'pin', description: 'Pin message - pin a message in channel', descriptionZh: '固定消息 - 在频道中固定消息', category: '消息' },
      { name: 'pins', description: 'List pinned messages', descriptionZh: '列出固定的消息', category: '消息' },
      { name: 'unpin', description: 'Unpin message - unpin a message', descriptionZh: '取消固定 - 取消固定消息', category: '消息' },
      { name: 'kick', description: 'Kick member - remove member from channel', descriptionZh: '踢出成员 - 从频道中移除成员', category: '消息' },
      { name: 'ban', description: 'Ban member - ban member from channel', descriptionZh: '封禁成员 - 在频道中封禁成员', category: '消息' },
      { name: 'timeout', description: 'Timeout member - timeout/mute member', descriptionZh: '禁言成员 - 禁言/静音成员', category: '消息' },
      { name: 'permissions', description: 'Manage permissions - manage channel permissions', descriptionZh: '管理权限 - 管理频道权限', category: '消息' },
    ],
    options: [
      { name: '--channel', description: 'Channel name (telegram, discord, whatsapp, etc.)', descriptionZh: '频道名称（telegram、discord、whatsapp 等）', required: false },
    ...
    examples: [
      ...
      'openclaw message poll --channel discord --target channel:123 --poll-question "What?" --poll-option "A" --poll-option "B"',
      'openclaw message broadcast --targets +15555550123,+15555550124 --message "Announcement"',
    ],
  },
  ...
  {
    name: 'plugins',
    description: 'Manage plugins and extensions - install, enable, disable, and manage Gateway plugins',
    descriptionZh: '管理插件和扩展 - 安装、启用、禁用和管理网关插件',
    category: '插件',
    subcommands: [
      { name: 'list', description: 'List plugins - show all installed plugins', descriptionZh: '列出插件 - 显示所有已安装的插件', category: '插件' },
      { name: 'info', description: 'Plugin info - show detailed information about a plugin', descriptionZh: '插件详情 - 显示插件的详细信息', category: '插件' },
      { name: 'install', description: 'Install plugin - install from path, npm spec, or marketplace', descriptionZh: '安装插件 - 从路径、npm 规格或市场安装', category: '插件' },
      { name: 'uninstall', description: 'Uninstall plugin - remove a plugin', descriptionZh: '卸载插件 - 移除插件', category: '插件' },
      { name: 'enable', description: 'Enable plugin - activate a disabled plugin', descriptionZh: '启用插件 - 激活已禁用的插件', category: '插件' },
      { name: 'disable', description: 'Disable plugin - deactivate an enabled plugin', descriptionZh: '禁用插件 - 停用已启用的插件', category: '插件' },
      { name: 'update', description: 'Update plugin - update a plugin to latest version', descriptionZh: '更新插件 - 将插件更新到最新版本', category: '插件' },
      { name: 'doctor', description: 'Plugin doctor - diagnose plugin issues', descriptionZh: '插件医生 - 诊断插件问题', category: '插件' },
      { name: 'marketplace', description: 'Marketplace - browse and search plugin marketplaces', descriptionZh: '市场 - 浏览和搜索插件市场', category: '插件' },
    ],
    options: [
      { name: '--json', description: 'JSON output', descriptionZh: 'JSON 输出', required: false },
    ],
    examples: [
      ...
      'openclaw plugins uninstall memory-openviking',
    ],
  },
  ...
  {
    name: 'browser',
    description: 'Manage browser automation - control Chrome/Chromium browser, manage profiles, tabs, and automation actions',
    descriptionZh: '管理浏览器自动化 - 控制 Chrome/Chromium 浏览器，管理配置文件、标签页和自动化操作',
    category: '自动化',
    subcommands: [
      { name: 'start', description: 'Start browser - launch or attach to a browser instance', descriptionZh: '启动浏览器 - 启动或附加到浏览器实例', category: '自动化' },
      ...
      { name: 'snapshot', description: 'Take DOM snapshot', descriptionZh: '获取 DOM 快照', category: '自动化' },
      { name: 'navigate', description: 'Navigate to URL', descriptionZh: '导航到 URL', category: '自动化' },
      { name: 'open', description: 'Open URL in new tab', descriptionZh: '在新标签页中打开 URL', category: '自动化' },
      ...
      { name: 'focus', description: 'Focus tab', descriptionZh: '聚焦标签页', category: '自动化' },
      { name: 'close', description: 'Close tab', descriptionZh: '关闭标签页', category: '自动化' },
      { name: 'tabs', description: 'Manage tabs - list, create, switch tabs', descriptionZh: '管理标签页 - 列出、创建、切换标签页', category: '自动化' },
      { name: 'profiles', description: 'List browser profiles', descriptionZh: '列出浏览器配置文件', category: '自动化' },
      { name: 'create-profile', description: 'Create new browser profile', descriptionZh: '创建新的浏览器配置文件', category: '自动化' },
      { name: 'delete-profile', description: 'Delete browser profile', descriptionZh: '删除浏览器配置文件', category: '自动化' },
